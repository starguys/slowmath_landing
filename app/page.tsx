...
const apps: App[] = [
  ...
  },
  {
    ...
    value:
      "10·50·100·500원 동전과 1,000·5,000·10,000·50,000원 지폐를 그림과 이름으로 짝지으며 자연스럽게 익혀요.",
  ...
  return (
    ...
    >
      ...
      <section
        ...
        className="px-6 py-10 sm:py-14 lazy-section"
        style={{
          borderBottom: "1px solid #EDE0C8",
          background:
      ...
      >
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          ...
          <figure
            className="relative rounded-2xl px-5 py-6 sm:px-7 sm:py-7 m-0"
            style={{
              background: "#FFFFFF",
              border: "1px solid #EDE0C8",
              boxShadow: "0 2px 10px rgba(45,38,32,0.04)",
            }}
          >
            <span
              aria-hidden
            ...
            <blockquote
              className="m-0 leading-relaxed break-keep"
              style={{ fontSize: "0.78rem", color: "#2D2620" }}
            >
              <p className="mb-3">
