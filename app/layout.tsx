...
export const metadata: Metadata = {
  ...
  description:
    "발달지연·느린학습자·경계선지능 등 느린아이들이 스스로 해내는 경험을 쌓도록 설계된 수학·인지 학습도구. 숫자 익히기·덧셈·뺄셈·구구단·시계 보기·비교하기·패턴 인지·소근육 발달 훈련까지. 학부모가 집에서 바로 활용할 수 있습니다.",
  keywords: [
    "느린 학습자 수학",
    "발달 지연 아이 수학 학습",
    "경계선 지능 학습도구",
  ...
  openGraph: {
    ...
    description:
      "발달지연·느린학습자·경계선지능 등 느린아이들이 자신의 속도로 기초 인지와 기초 수학을 차근차근 연습하도록 설계된 학습도구입니다.",
    siteName: "느린아이",
    locale: "ko_KR",
    type: "website",
    images: [
  ...
  twitter: {
    ...
    title: "느린아이 - 한 걸음씩, 아이의 속도로",
    description:
      "발달지연·느린학습자·경계선지능 등 느린아이들이 자기 속도로 수학의 기초를 쌓는 학습도구. App Store에서 만나보세요.",
