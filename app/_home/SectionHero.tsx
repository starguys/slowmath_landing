...
const C: Record<Locale, HeroCopy> = {
  ko: {
    ...
    descLines: [
      [{ t: "발달지연·경계선 지능·느린학습자 또는", bold: true }],
      [
        { t: "또래보다 천천히 배우는 아이", bold: true },
        { t: "가 자신의 속도로" },
      ],
      [{ t: "기초 인지와 기초 수학을 차근차근" }],
      [{ t: "연습하도록 설계된 학습도구입니다." }],
    ],
  },
  zh: {
    ...
    cardLines: [
      [{ t: "KAIST 出身、" }],
      [{ t: "自閉症光譜孩子的爸爸", c: "o" }, { t: "，" }],
      [{ t: "以自身經驗親手打造的 " }, { t: "LittleSteps", c: "b" }],
    ],
    descLines: [
      [{ t: "發展遲緩、臨界智能，", bold: true }],
      [{ t: "或任何比同齡孩子學得慢的孩子", bold: true }],
      [{ t: "都能照自己的速度，一步步練習" }],
      [{ t: "認知與數學的基礎。" }],
    ],
  },
