...
const C = {
  ...
  zhcn: {
    heading: "要从哪里开始呢？",
    subtitle: "马上找到适合孩子现在程度的工具",
    tiers: [
      {
        step: "第 1 阶段",
        titleLines: ["还不认得数字和颜色"],
        subLines: ["数感的起点！", "从数字的名称、颜色的名称、", "用眼睛数开始。"],
      },
      {
        step: "第 2 阶段",
        titleLines: ["握笔和书写很吃力"],
        subLines: ["写字之前一定需要的", "手部控制与手眼协调，", "一步步培养起来。"],
      },
      {
        step: "第 3 阶段",
        titleLines: ["比较与找规律", "很困难"],
        subLines: ["用大小比较、位置语言、", "重复的规律，打好", "数学思考的基础。"],
      },
      {
        step: "第 4 阶段",
        titleLines: ["认得数字，", "但加法很难"],
        subLines: ["通过连结数与量、集合与", "分开的经验，累积加法的", "概念。"],
      },
    ],
  },
  en: {
  ...
  ja: {
    heading: "どこから始めましょうか?",
    subtitle: "お子さんの今の水準に合ったツールをすぐに見つけられます",
    tiers: [
      {
        step: "ステップ1",
        titleLines: ["数字も色もまだ分かりません"],
        subLines: [
          "数感覚のスタート地点。",
          "数字の名前・色の名前・目で",
          "かぞえるところから始めます。",
      ...
      {
        step: "ステップ3",
        titleLines: ["比べたり・きまりを見つけるのが", "むずかしい"],
        subLines: [
          "大きさの比較、位置の言葉、",
          "くり返しのパターンで算数的な",
          "思考力の土台をつくります。",
      ...
      {
        step: "ステップ4",
        titleLines: ["数字は分かるけれど", "たし算がむずかしい"],
        subLines: [
          "数と量をつなげ、あつめて",
          "わける経験を通してたし算の",
          "概念を積み上げます。",
