...
export const MODAL_CONTENT: Record<string, Record<Locale, ModalText>> = {
  ...
  slowmath_easysub: {
    ko: {
      ...
      long: "덜어내는 감각을 그림으로 시각화하며 한 자리 뺄셈의 의미를 자연스럽게 익힐 수 있어요. 4단계 난이도로 부담 없이 시작해 반복 노출을 통해 자기 속도에 맞게 자동화 단계까지 이어집니다.",
    },
    en: {
      category: "Subtraction",
      subtitle: "Calculation, one step removed at a time",
      ...
      long: "Visualizes the feeling of taking away one at a time, so single-digit subtraction settles in naturally. Four difficulty levels ease children in without pressure, letting repeated exposure carry them to automatization at their own pace.",
    },
  },
  slowmath_subtract: {
    ko: {
