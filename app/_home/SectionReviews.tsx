...
const C = {
  ko: {
    ...
    reviews: [
      {
        photo: "/reviews/ckdgus5290.png",
        photoAlt: "느린아이 앱으로 색깔 연습을 하고 있는 아이",
        quote:
          "한 영역에서 충분히 반복학습 할 수 있다는 점도 느린아이를 위한 수개념 바로 잡기 너무 좋았어요. 느린학습자에게 반복학습은 무척 중요하잖아요. 학습지로 풀기에는 한계가 있고, 엄마가 문제를 내기에도 한계가 있는데 이 어플 정말 대박인 거 같아요. 기초인지부터 덧셈, 뺄셈, 시계 보기, 달력 보기 등등 세분화되어 있어 아이가 자기 수준부터 차근차근 학습해 가기 좋아요. 개념을 익혔나 싶으면 또 틀리고, 헷갈려하니까 어떻게 가르쳐야 하나 고민했었는데 느린아이 어플 덕분에 아이가 편하게 기초학습 진행할 수 있었답니다.",
        rating: 5,
      ...
      } as Review,
      {
        ...
        quote:
          "첫 번째로 해본 건 거스름돈 만들기 문제였어요. 290원짜리 물건을 사고 1000원을 냈을 때 거스름돈을 동전으로 직접 만들어보는 문제였는데, 십원·오십원·백원·오백원 동전을 하나씩 눌러가며 스스로 계산해보는 방식이라 그냥 답만 입력하는 것보다 돈의 개념, 수개념을 체득하는 데 훨씬 도움이 되는 것 같았어요. 아이가 처음엔 헷갈려하다가 몇 번 눌러보더니 스스로 답을 맞춰내더라고요. 그 순간 옆에서 지켜보는 저도 은근 뿌듯했어요.",
        rating: 5,
