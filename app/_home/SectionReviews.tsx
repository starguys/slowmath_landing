    ...
    reviews: [
      {
        ...
        quote:
          "이 어플은 오롯이 문제에만 집중할 수 있다보니 아이가 더 오래 집중해서 수개념을 익힐 수 있었어요. 한 영역에서 충분히 반복학습 할 수 있다는 점도 느린아이를 위한 수개념 바로 잡기 너무 좋았어요. 느린학습자에게 반복학습은 무척 중요하잖아요. 학습지로 풀기에는 한계가 있고, 엄마가 문제를 내기에도 한계가 있는데 이 어플 정말 대박인 거 같아요. 기초인지부터 덧셈, 뺄셈, 시계 보기, 달력 보기 등등 세분화되어 있어 아이가 자기 수준부터 차근차근 학습해 가기 좋아요.",
        rating: 5,
