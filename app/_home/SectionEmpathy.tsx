...
const C = {
  ...
  zh: {
    ...
    tag: "在開始之前",
    worries: [
      { lead: "買了練習本，", strong: "翻兩頁就哭了" },
      { lead: "數字 1 到 10，好幾個月了還", strong: "停在同一個地方" },
      { lead: "只要錯一次，", strong: "就再也不肯做了" },
      { lead: "同齡的教材太快，", strong: "幼兒的教材又太幼稚" },
    ],
    closingHeading: "那份心情，我們也懂",
    closingLead: "所以我們做了配合孩子速度的小小練習。",
    closingLead2: "一個畫面、一步，",
    closingStrong: "照著孩子的速度，慢慢一起走",
    cta: "看更多",
  },
  zhcn: {
    titleAccent: "这些话，",
    ...
    tag: "在开始之前",
    worries: [
      { lead: "买了练习本，", strong: "翻两页就哭了" },
      { lead: "数字 1 到 10，好几个月了还", strong: "停在同一个地方" },
      { lead: "只要错一次，", strong: "就再也不肯做了" },
      { lead: "同龄的教材太快，", strong: "幼儿的教材又太幼稚" },
    ],
    closingHeading: "那份心情，我们也懂",
    closingLead: "所以我们做了配合孩子速度的小小练习。",
    closingLead2: "一个画面、一步，",
    closingStrong: "照着孩子的速度，慢慢一起走",
    cta: "看更多",
  },
  en: {
