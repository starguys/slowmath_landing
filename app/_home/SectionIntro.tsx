...
const C = {
  ko: {
    ...
    emRest: "했습니다.",
    b1Lead: "느린아이는 ",
    b1Strong: "발달지연·경계선 지능·느린학습자 또는 또래보다 천천히 배우는 아이",
    b1Rest: "가 기초 인지와 기초 수학의 개념을 스스로 익힐 수 있도록 만들어진 학습도구 모음입니다.",
  ...
  en: {
    ...
    b1Strong:
      "children with developmental delays, borderline intellectual functioning, or any child who learns more slowly than their peers",
