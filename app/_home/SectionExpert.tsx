...
const C = {
  ...
  zh: {
    ...
    headAccent2: "專家",
    headMid: "",
    headLine2: "推薦 LittleSteps 的理由",
    quote: [
      "教過需要比別人更多練習與反覆的孩子的家長和老師，應該都能體會：要找到適合我們孩子的教材與資料，實在不容易。",
      "能引起一時興趣的教材很多，但能幫助孩子一步步紮實累積的學習資料卻一直很缺乏，這點總讓人惋惜。",
      "而 LittleSteps，我認為是足以化解這份惋惜與鬱悶的數學學習應用程式。",
      "因為是養育學得慢的孩子的家長，一邊親自教孩子一邊做出來的應用程式，內容都貼近我們孩子的視角，該有的都仔細地放進去了。",
      "我自己在臨床現場，看到孩子們學得更開心、也更喜歡，因此很想把這個應用程式推薦給更多人。",
      "而且我認為，不只是學得慢的孩子，對剛開始學基礎認知的孩子、需要在入學前打好基礎的孩子來說，它也會是很有用的學習指引。",
    ],
    name: "張佑榮",
    credentials: [
      "Mom&Mom 兒童發展中心院長",
  ...
  zhcn: {
    ...
    headAccent2: "专家",
    headMid: "",
    headLine2: "推荐 LittleSteps 的理由",
    quote: [
      "教过需要比别人更多练习与反复的孩子的家长和老师，应该都能体会：要找到适合我们孩子的教材与资料，实在不容易。",
      "能引起一时兴趣的教材很多，但能帮助孩子一步步扎实累积的学习资料却一直很缺乏，这点总让人惋惜。",
      "而 LittleSteps，我认为是足以化解这份惋惜与郁闷的数学学习应用程序。",
      "因为是养育学得慢的孩子的家长，一边亲自教孩子一边做出来的应用程序，内容都贴近我们孩子的视角，该有的都仔细地放进去了。",
      "我自己在临床现场，看到孩子们学得更开心、也更喜欢，因此很想把这个应用程序推荐给更多人。",
      "而且我认为，不只是学得慢的孩子，对刚开始学基础认知的孩子、需要在入学前打好基础的孩子来说，它也会是很有用的学习指引。",
    ],
    name: "张佑荣",
    credentials: [
      "Mom&Mom 儿童发展中心院长",
  ...
  ja: {
    ...
    headAccent2: "専門家",
    headMid: "が",
    headLine2: "LittleStepsをおすすめする理由",
    quote: [
      "他の子より多くの練習とくり返しが必要な子を教えた経験のある保護者や先生方には共感していただけると思います。うちの子たちに合った学習教材や資料を見つけるのは本当にむずかしいのです。",
      "一瞬の興味を引ける学習教材はたくさんありますが、少しずつ身につけながら実力を積み上げていける学習資料が足りない、といつも残念に思っていました。",
      "そんな中でLittleStepsは、その物足りなさをじゅうぶんに解消してくれる算数の学習アプリだと思います。",
      "自分のペースで学ぶ子を育てる保護者ご自身が、実際にお子さんを教えながら作られたアプリなので、うちの子たちの目線に合った、本当に必要な内容が丁寧に組み立てられています。",
      "私自身、臨床の現場で子どもたちがより楽しそうに学び、心から気に入ってくれる様子を見ていて、たくさんの方にぜひこのアプリをおすすめしたいと感じています。",
      "自分のペースで学ぶ子だけでなく、基礎認知を学び始めたばかりのお子さんや、就学前に基礎固めが必要なお子さんにも、とても役に立つ学習の道しるべになると思います。",
    ],
    name: "チャン・ウヨン",
    credentials: [
      "マム&マム児童発達センター 院長",
